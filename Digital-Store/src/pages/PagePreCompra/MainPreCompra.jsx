...
export default function MainPreCompra(){ 
    ...
    return( 
        <div className="bg-[#F9F8FE]"> 
            <div className="flex"> 
                <div className="min-w-fit h-fit bg-white p-[2%] ml-[6%] mt-[7%]"> 
                    <div className="flex"> 
                        <p className="font-bold text-[#474747] text-[14px] tracking-wide w-[350px] h-[36px]">MEU CARRINHO</p> 
                        <p className="font-semibold text-[#474747] tracking-wide text-[14px] w-[170px]">QUANTIDADE</p> 
                        <p className="font-semibold text-[#474747] tracking-wide text-[14px] w-[170px]">UNITÁRIO</p> 
                        <p className="font-semibold text-[#474747] tracking-wide text-[14px]">TOTAL</p> 
                    </div> 
                    <hr className="mt-[1%] mb-[4%]"/> 
                    <div className="flex"> 
                        <img className="w-[100px] h-[100px] bg-[#E2E3FF]" src="src\assets\image\White-Sneakers-PNG-Clipart 2.png" alt="" /> 
                        <div className="grid space-y-[4%]"> 
                            <p className="text-[#1F1F1F] w-full tracking-wider ml-[5%] font-bold text-[14px]">Tênis Nike Revolution 6 Next<br/>Nature Masculino</p> 
                            <div className="flex"> 
                                <p className="text-[#474747] tracking-wider ml-[5%] font-semibold text-[12px]">Cor:</p> 
                                <p className="text-[#1F1F1F] w-full tracking-wider ml-[5%] font-bold text-[12px]">Vermelho / Branco</p> 
                            </div> 
                            <div className="flex"> 
                                <p className="text-[#474747] tracking-wider ml-[5%] font-semibold text-[12px]">Tamanho:</p> 
                                <p className="text-[#1F1F1F] w-full tracking-wider ml-[5%] font-bold text-[12px]">42</p> 
                            </div> 
                        </div> 
                        ...
                        <div className="grid ml-[10%]">
                            <del className="text-[#CCCCCC]"><p className="text-[#CCCCCC] font-semibold text-[14px]">R$ 219,00</p></del>
                    ...
                    <div className="flex w-fit gap-[10%]"> 
                        <div className="grid mt-[5%]"> 
                            <p className="font-extrabold text-[#474747] text-[10px] tracking-wide">CUPOM DE DESCONTO</p> 
                        ...
                        <div className="grid mt-[5%]"> 
                            <p className="font-extrabold text-[#474747] text-[10px] tracking-wide">CALCULAR FRETE</p> 
                            <div className="flex mt-[5%]"> 
                ...
                <div className="w-fit ml-[4%] mt-[7%] bg-white p-[1%]"> 
                    ...
                    <hr className=""/> 
                    <div className="flex"> 
                        <img className="w-[90px] h-[70px] bg-[#E2E3FF]" src="src\assets\image\White-Sneakers-PNG-Clipart 2.png" alt="" /> 
