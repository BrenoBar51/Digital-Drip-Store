    ...
    return(
        <div className="flex gap-[10%]">
            <button className={`
                ...
                ${props.type === 'retangulo' && 'w-[220px] h-[48px] text-Branbg-Branco flex-shrink-0 bg-Rosa rounded-lg hover:bg-Roxo hover:transition-[2s]'}
                ${props.type2 === 'retangulo2' && 'w-[124px] h-[40px] text-Branbg-Branco flex-shrink-0 bg-Rosa rounded-lg hover:bg-Roxo hover:transition-[2s]'}
