...
export default function Buttons(props){
    return(
        <div className="flex gap-[10%]">
            <button className={`
                ${props.graybtn === 'gray' && 'text-[#474747] text-[14px] font-medium leading-[22px] tracking-[0.25px] underline  '}
                ${props.value2 === 'Entrar' && 'text-[#ffffff] w-[114px] h-[40px] flex-shrink-0 bg-[#C92071] mt-[8%] rounded-lg hover:bg-[#991956] hover:transition-[2s]'}
                ${props.type === 'retangulo' && 'w-[220px] h-[48px] text-[#ffffff] flex-shrink-0 bg-[#C92071]  rounded-lg hover:bg-[#991956] hover:transition-[2s]'}
